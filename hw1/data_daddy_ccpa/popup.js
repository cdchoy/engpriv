document.addEventListener('DOMContentLoaded', function() {
  ...
  document.getElementById('generateEmail').setAttribute("href", "https://www.w3schools.com");
  generateEmail.setAttribute("href", "");
...
function changeColor(newColor) {
  var elem = document.getElementById('generateEmail');
